...
import 'package:fluttercalendar_app/students/view/studentBuyItems.dart';
import 'package:fluttercalendar_app/students/view/studentCreateTutorScreen.dart';
...
import 'package:fluttercalendar_app/students/view/studentRequestTutorListScreen.dart';
import 'package:fluttercalendar_app/students/view/studentSellItems.dart'; // Import the studentSellItems.dart file
import 'package:fluttercalendar_app/students/view/studentTutorListScreen.dart';
import 'package:fluttercalendar_app/students/view/studentTutorRegisterScreen.dart';
    ...
    List<Widget> services = [
      ServiceCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => StudentBuyItems()),
          );
        },
      ...
      ServiceCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => StudentSellItems()),
          );
        },
      ...
      ServiceCard(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => studentTutorRegisterScreen()),
          );
        },
