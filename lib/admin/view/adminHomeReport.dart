...
import 'package:fluttercalendar_app/admin/view/adminManageReportScreen.dart';
import 'package:fluttercalendar_app/students/view/studentReportHistory.dart';
import 'package:google_fonts/google_fonts.dart';



class AdminHomeReport extends StatelessWidget {
  @override
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AdminManageReportScreen()),
                        );
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent,
